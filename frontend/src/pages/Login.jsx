  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[10%] left-[-5%] w-[500px] h-[500px] bg-[#00F5FF]/10 rounded-full blur-[120px] animate-pulse-slow" />
        <div className="absolute bottom-[10%] right-[-5%] w-[500px] h-[500px] bg-[#6C63FF]/10 rounded-full blur-[120px] animate-pulse-slow" />
        <div className="absolute top-[40%] right-[10%] w-[300px] h-[300px] bg-[#bf5af2]/5 rounded-full blur-[100px] animate-pulse-slow delay-700" />
      </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end">
            <button type="button" className="text-xs font-bold text-gray-500 hover:text-[#6C63FF] transition-colors">
              Forgot password?
            </button>
          </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400 font-bold">
            New to CatCatchCode?{' '}
            <Link to="/register" className="text-[#6C63FF] dark:text-[#00F5FF] hover:underline transition-all">
              Create an account
            </Link>
          </p>
        </div>
