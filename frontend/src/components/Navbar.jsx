...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 dark:bg-[#0F0C29]/80 backdrop-blur-lg shadow-md border-b border-gray-200 dark:border-white/10 transition-colors duration-300">
